        ...
        >
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 bg-white p-8 rounded-lg shadow-lg">
                ...
                <motion.div
                    ...
                    className="md:w-1/2"
                >
                    <h2 className="text-2xl font-semibold text-primary mb-4">Realty Tunax'a Hoş Geldiniz</h2>
                    <p className="text-gray-700 leading-relaxed mb-4">
                        2025 yılında, Akdeniz'in incisi Antalya'da gayrimenkul sektörüne yeni bir soluk ve dinamik bir bakış açısı getirme hedefiyle yola çıktık. Realty Tunax olarak, şehrin en merkezi ve değerli lokasyonlarından biri olan Meltem'de, sektörün geleceğini şekillendiren yenilikçi hizmet anlayışımızla faaliyetlerimize başladık. Bizler, İsmail Tuna ve Recep Tuna, ortak bir vizyon ve gayrimenkule duyduğumuz tutkuyla, sizlere sadece bir mülk değil, doğru bir gelecek yatırımı sunmak için buradayız.</p>
                    <p className="text-gray-700 leading-relaxed">
                        Temel prensibimiz, müşteri memnuniyetini en üst düzeyde tutarak, uzun soluklu ve güvene dayalı ilişkiler kurmaktır. Realty Tunax olarak, hayallerinizdeki eve veya doğru yatırım fırsatına ulaşmanız için buradayız.
                    </p>
                </motion.div>
            </div>
            <div className="text-center">
                <h2 className="text-3xl font-bold text-primary mb-4">Ekibimizle Tanışın</h2>
                <p className="text-gray-600 mt-2 mb-12">Başarımızın arkasındaki yüzler.</p>
            </div>
                ...
                {teamMembers.map((member, index) => (
                    ...
                    >
                        ...
                        <div className="flex justify-center space-x-4">
                            ...
                            <a href={member.social.email} className="text-gray-500 hover:text-primary transition-colors">
                                <Mail size={24} />
                            </a>
                        </div>
                    </motion.div>
